...
Both data sources have geographic coordinates for every observation

## Loading NOAA Data

NOAA data is a binary R file so we need to read it specially:

1. Download the data from https://raw.githubusercontent.com/heike/summerschool-2018/master/02-graphics/data/noaa.rdata
2. Run the `getwd()` command to find your current working directory
3. Place noaa.rdata in the directory from step 2.
4. Run the command below:

```{r}
if (!file.exists("../data/noaa.rdata"))
  download.file("https://raw.githubusercontent.com/heike/summerschool-2018/master/02-graphics/data/noaa.rdata", "../data/noaa.rdata")
...
aesthetic mapping   scale
--------- --------- ---------
x         Longitude continuous
y         Latitude  continuous
color     CallSign  discrete
...
More geoms described at http://ggplot2.tidyverse.org/reference/
