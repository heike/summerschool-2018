...
* with python most commonly used data science software (52.1% versus 52.6%) [18th annual poll on software for Analytics, Data Mining, Data Science, Machine Learning (kdnuggets)](http://www.kdnuggets.com/2017/05/poll-analytics-data-science-machine-learning-software-leaders.html)
...
Slides and material are available at
 http://heike.github.io/summerschool-2018


#  http://heike.github.io/<br>summerschool-2018
...
```{r, eval = FALSE}
curl::curl_download(
  "https://raw.githubusercontent.com/heike/summerschool-2018/master/01-Introduction-to-R/knitr/0-getting-started.Rmd",
...
```{r, eval = FALSE}
curl::curl_download(
  "https://raw.githubusercontent.com/heike/summerschool-2018/master/01-Introduction-to-R/code/0-getting-started.R",
  "0-getting-started.R"
)
