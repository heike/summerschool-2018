...
```{r, eval = FALSE}
curl::curl_download(
  "https://raw.githubusercontent.com/heike/summerschool-2018/master/01-Introduction-to-R/knitr/5-rmarkdown.Rmd",
  "5-rmarkdown.Rmd"
)
...
<div align="center">
  <img src="images/knit.png" width=750>
</div>
...
In this case, when you click "Knit HTML", RStudio calls `rmarkdown::render("file.Rmd", html_document())`. You can certainly change these default values (see the [source of this presentation](https://raw.githubusercontent.com/heike/summerschool-2018/master/01-Introduction-to-R/knitr/5-rmarkdown.Rmd)).
...
```{r, results='asis'}
library(pander)
# pander(m)  # not on Mac OS :(
stargazer::stargazer(m, type = 'html')
```
